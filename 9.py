...
stax = eval(input("Enter state tax withholding rate (e.g., 9%): "))
...
print(f"   State Withholding ({tax*100}%): {hours * stax*pay_rate:.3}")
print(f"   Total Deduction: {hours * tax*pay_rate + stax* hours *pay_rate:.4} Net Pay: {hours*pay_rate - (hours * tax*pay_rate + stax* hours *pay_rate):.4}")
